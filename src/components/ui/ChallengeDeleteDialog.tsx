...
export default function ChallengeDeleteDialog({
    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="DialogContent">
          <Dialog.Title className="DialogTitle">Remove Challenge</Dialog.Title>
          <Dialog.Description className="DialogDescription">
            The challenge will be removed, Are you sure?
          </Dialog.Description>
          <div className='flex gap-4 mt-6 justify-end'>
            <button className="Button red cursor-pointer disabled:cursor-default" 
            disabled={loading} onClick={(e) => {handleDelete(e)}}>Yes, Delete</button>
